export default {
    ...
    WALLET_INSTALLATION_NOTE: '<p>At the moment, only EVER Wallet supports DexADA.</p><p>If you haven’t installed the extension yet, you can do it at <a href="https://chrome.google.com/webstore/detail/ever-wallet/cgeeodpfagjceefieflmdfphplkenlfk" target="_blank" rel="nofollow noopener noreferrer">chrome.google.com</a></p>',
    ...
    FOOTER_NAV_HEADER_PRODUCT: 'DexADA',
    ...
    OG_META_DESCRIPTION: 'Everscale powered DEX and farming hub. Exchange assets and explore a multitude of farming and vesting opportunities.',
}
