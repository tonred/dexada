...
export default {
    ...
    WALLET_INSTALLATION_NOTE: '<p>At the moment, only EVER Wallet supports DexADA.</p><p>If you haven’t installed the extension yet, you can do it at <a href="https://chrome.google.com/webstore/category/extensions" target="_blank" rel="nofollow noopener noreferrer">chrome.google.com</a></p>',
    ...
    FOOTER_NAV_TON_BRIDGE_LINK_TEXT: 'Octus Bridge',
    ...
    POOL_DATA_SUBTITLE_DEX_ACCOUNT: 'DexADA account balance',
    ...
    POOL_ROOTS_INFO_LABEL_DEX_ADDRESS: 'DexADA account address',
    ...
    POOL_SUPPLY_RECEIPT_SUCCESSFUL_NOTE: '<p>Supply completed successfully.</p><p>LP token root <a href="https://tonscan.io/accounts/{address}" target="_blank" rel="nofollow noopener noreferrer">contract</a>.</p><p>You can view the result transaction in the <a href="https://tonscan.io/transactions/{transactionHash}" target="_blank" rel="nofollow noopener noreferrer">explorer</a>.</p>',
