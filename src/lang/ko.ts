export default {
    ...
    WALLET_INSTALLATION_NOTE: '<p>현재 톤스왑은 크리스탈 월릿만 지원합니다</p><p>확장프로그램을 아직 설치하지 않으셨다면 여기에서 설치 가능합니다.<a href="https://chrome.google.com/webstore/detail/ever-wallet/cgeeodpfagjceefieflmdfphplkenlfk" target="_blank" rel="nofollow noopener noreferrer">chrome.google.com</a></p>',
    ...
    REMOVE_LIQUIDITY_SUCCESS_SUBMIT: 'TON 스캔에서 보기',
